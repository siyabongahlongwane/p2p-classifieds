    ...
    fetchChats: async (req, res) => {
        try {
            ...
            const chats = await Chat.findAll({
                ...
                include: [
                    { model: User, as: 'user1', attributes: ['user_id', 'first_name', 'last_name', 'email'] },
                    { model: User, as: 'user2', attributes: ['user_id', 'first_name', 'last_name', 'email'] },
                    {
                        model: Message,
                        as: 'lastMessage',
            ...
            res.json({ success: true, payload: formattedChats });
